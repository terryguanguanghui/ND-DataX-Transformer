...
public class AESCipher {
	...
	private static final String AESKEY = "nMYQMnSuwX3V2lnNu80AqA==";
	...
	public static String generateRandomKey(){
		...
		try {
			kg = KeyGenerator.getInstance(CIPHER_TYPE);
	...
	public static String encrypt(String content) throws Exception {
		SecretKey key = new SecretKeySpec(decoder.decode(AESKEY), CIPHER_TYPE);
