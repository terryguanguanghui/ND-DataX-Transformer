...
public class PhoneNumberTransformer extends Transformer {

    public PhoneNumberTransformer() {
        setTransformerName("dx_phone_number");
        System.out.println("手机号码脱敏");
    }
    ...
    public Record evaluate(Record record, Object... paras) {
        ...
        try {
            if (paras.length < 1) {
                throw new RuntimeException("dx_phone_number transformer 缺少参数");
            }
    ...
    class Item{
        ...
        public Item(@PhoneNumberSensitive String item) {
            this.item = item;
        }
    }
