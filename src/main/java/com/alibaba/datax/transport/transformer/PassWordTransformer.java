...
public class PassWordTransformer extends Transformer {

    public PassWordTransformer() {
        setTransformerName("dx_password");
        System.out.println("密码脱敏");
    }
    ...
    public Record evaluate(Record record, Object... paras) {
        ...
        try {
            if (paras.length < 1) {
                throw new RuntimeException("dx_password transformer 缺少参数");
            }
    ...
    class Item{
        ...
        public Item(@PasswordSensitive String item) {
            this.item = item;
        }
    }
